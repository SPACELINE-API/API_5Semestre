...
function LoginPage() {
	...
	async function handleSubmit(event: FormEvent) {
		...
		const nextErrors = {
			email: !email.trim() ? 'Informe seu e-mail.' : undefined,
		...
		<main className="login-page">
			<section className="login-panel">
				<div className="brand">
					...
					<span>Aliança Traduções</span>
				</div>
				<h1>Acesse sua conta</h1>
				<p className="intro">
					Entre para acompanhar orçamentos, solicitações e
					<br className="desktop-break" /> documentos de tradução em um só
					lugar.
				</p>
				...
				<p className="register">
					Ainda não tem acesso? <a href="/register">Solicite seu cadastro</a>
				</p>
			</section>
