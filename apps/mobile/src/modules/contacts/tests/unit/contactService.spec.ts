...
test.describe('createContact', () => {
    ...
    test('API error', async () => {
        ...
        await expect(createContact(payload))
            .rejects
...
test.describe('getContact', () => {
    ...
    test('contact not found (404)', async () => {
        ...
        await expect(getContact('id-inexistente'))
            .rejects
    ...
    test('API error', async () => {
        ...
        await expect(getContact(mockContact.id))
            .rejects
...
test.describe('deleteContact', () => {
    test('success - should call DELETE method', async () => {
        ...
        await expect(deleteContact(mockContact.id))
            .resolves
            .toBeUndefined();
    });
    ...
    test('conflict (409)', async () => {
        ...
        await expect(deleteContact(mockContact.id))
            .rejects
            .toThrow('Cannot delete contact with history.');
    });
